...
def register():
    ...
    samplers = [("halton", "halton", "", 1), ("maxmindist", "maxmindist", "", 2),("random", "random", "", 3),("sobol", "sobol", "", 4),("stratified", "stratified", "", 5),("lowdiscrepancy", "lowdiscrepancy", "", 6), ("PCGSampler", "PCGSampler", "", 7)]
