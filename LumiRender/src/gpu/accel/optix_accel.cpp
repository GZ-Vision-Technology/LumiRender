...
//            _program_group_table = shader_wrapper.create_program_groups(obtain_module(optix_shader_code),
//                                                                        _optix_device_context, program_name);


            _program_group_table = shader_wrapper._program_group_table;
