        ...
        throw std::runtime_error
                ("trying to set variable to value of wrong type.\n"
                 "note: name of variable is " + std::string(varDecl->name) + "\n"
                                                                             "note: type of variable is " +
                 typeToString(varDecl->type) + "\n"
                                               "note: type of value attempted to be set is " + attemptedType
                );
    }

    void Variable::set(const std::shared_ptr<Buffer> &value) { mismatchingType("Buffer"); }

    void Variable::set(const std::shared_ptr<Group> &value) { mismatchingType("Group"); }

    void Variable::set(const std::shared_ptr<Texture> &value) { mismatchingType("Texture"); }

    void Variable::setRaw(const void *ptr) { mismatchingType("void*"); }


    void Variable::set(const bool &value) { mismatchingType("bool"); }

    void Variable::set(const vec2b &value) { mismatchingType("bool2"); }

    void Variable::set(const vec3b &value) { mismatchingType("bool3"); }

    void Variable::set(const vec4b &value) { mismatchingType("bool4"); }


    void Variable::set(const int8_t &value) { mismatchingType("char"); }

    void Variable::set(const vec2c &value) { mismatchingType("char2"); }

    void Variable::set(const vec3c &value) { mismatchingType("char3"); }

    void Variable::set(const vec4c &value) { mismatchingType("char4"); }

    void Variable::set(const uint8_t &value) { mismatchingType("uchar"); }

    void Variable::set(const vec2uc &value) { mismatchingType("uchar2"); }

    void Variable::set(const vec3uc &value) { mismatchingType("uchar3"); }

    void Variable::set(const vec4uc &value) { mismatchingType("uchar4"); }


    void Variable::set(const int16_t &value) { mismatchingType("short"); }

    void Variable::set(const vec2s &value) { mismatchingType("short2"); }

    void Variable::set(const vec3s &value) { mismatchingType("short3"); }

    void Variable::set(const vec4s &value) { mismatchingType("short4"); }

    void Variable::set(const uint16_t &value) { mismatchingType("ushort"); }

    void Variable::set(const vec2us &value) { mismatchingType("ushort2"); }

    void Variable::set(const vec3us &value) { mismatchingType("ushort3"); }

    void Variable::set(const vec4us &value) { mismatchingType("ushort4"); }


    void Variable::set(const int32_t &value) { mismatchingType("int"); }

    void Variable::set(const vec2i &value) { mismatchingType("int2"); }

    void Variable::set(const vec3i &value) { mismatchingType("int3"); }

    void Variable::set(const vec4i &value) { mismatchingType("int4"); }

    void Variable::set(const uint32_t &value) { mismatchingType("uint"); }

    void Variable::set(const vec2ui &value) { mismatchingType("uint2"); }

    void Variable::set(const vec3ui &value) { mismatchingType("uint3"); }

    void Variable::set(const vec4ui &value) { mismatchingType("uint4"); }

    void Variable::set(const int64_t &value) { mismatchingType("long"); }

    void Variable::set(const vec2l &value) { mismatchingType("long2"); }

    void Variable::set(const vec3l &value) { mismatchingType("long3"); }

    void Variable::set(const vec4l &value) { mismatchingType("long4"); }

    void Variable::set(const uint64_t &value) { mismatchingType("ulong"); }

    void Variable::set(const vec2ul &value) { mismatchingType("ulong2"); }

    void Variable::set(const vec3ul &value) { mismatchingType("ulong3"); }

    void Variable::set(const vec4ul &value) { mismatchingType("ulong4"); }

    void Variable::set(const float &value) { mismatchingType("float"); }

    void Variable::set(const vec2f &value) { mismatchingType("float2"); }

    void Variable::set(const vec3f &value) { mismatchingType("float3"); }

    void Variable::set(const vec4f &value) { mismatchingType("float4"); }

    void Variable::set(const double &value) { mismatchingType("double"); }

    void Variable::set(const vec2d &value) { mismatchingType("double2"); }

    void Variable::set(const vec3d &value) { mismatchingType("double3"); }

    void Variable::set(const vec4d &value) { mismatchingType("double4"); }

    void Variable::set(const affine3f &value) { mismatchingType("affine3f"); }
    ...
    struct GroupVariable : public Variable {
        ...
        void set(const Group::SP &value) override {
            if (value && !std::dynamic_pointer_cast<InstanceGroup>(value))
                throw std::runtime_error(
                        "OWL currently supports only instance groups to be passed to traversal; if you do want to trace rays into a single User or Triangle group, please put them into a single 'dummy' instance with jsut this one child and a identity transform");
            this->group = value;
        }
