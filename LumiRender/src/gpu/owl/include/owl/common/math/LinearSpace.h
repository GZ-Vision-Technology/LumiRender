...
namespace owl {
    namespace common {
        ...
        template<typename T>
        struct OWL_INTERFACE LinearSpace2 {
            using vector_t = T;
            ...
            inline __both__ LinearSpace2(const LinearSpace2 &other) {
                vx = other.vx;
                vy = other.vy;
            }

            inline __both__ LinearSpace2 &operator=(const LinearSpace2 &other) {
                vx = other.vx;
                vy = other.vy;
                return *this;
            }
            ...
            inline __both__ LinearSpace2(const LinearSpace2<L1> &s) : vx(s.vx), vy(s.vy) {}
        ...
        template<typename T>
        __both__ inline LinearSpace2<T> operator-(const LinearSpace2<T> &a) { return LinearSpace2<T>(-a.vx, -a.vy); }

        template<typename T>
        __both__ inline LinearSpace2<T> operator+(const LinearSpace2<T> &a) { return LinearSpace2<T>(+a.vx, +a.vy); }

        template<typename T>
        __both__ inline LinearSpace2<T> rcp(const LinearSpace2<T> &a) { return a.inverse(); }
        ...
        template<typename T>
        inline LinearSpace2<T> operator+(const LinearSpace2<T> &a, const LinearSpace2<T> &b) {
        ...
        template<typename T>
        inline LinearSpace2<T> operator*(const typename T::scalar_t &a, const LinearSpace2<T> &b) {
            return LinearSpace2<T>(a * b.vx, a * b.vy);
        }

        template<typename T>
        inline T operator*(const LinearSpace2<T> &a, const T &b) { return b.x * a.vx + b.y * a.vy; }
        ...
        template<typename T>
        inline LinearSpace2<T> operator/(const LinearSpace2<T> &a, const typename T::scalar_t &b) {
            return LinearSpace2<T>(a.vx / b, a.vy / b);
        }

        template<typename T>
        inline LinearSpace2<T> operator/(const LinearSpace2<T> &a, const LinearSpace2<T> &b) { return a * rcp(b); }

        template<typename T>
        inline LinearSpace2<T> &operator*=(LinearSpace2<T> &a, const LinearSpace2<T> &b) { return a = a * b; }
        ...
        template<typename T>
        inline bool operator==(const LinearSpace2<T> &a, const LinearSpace2<T> &b) {
        ...
        struct OWL_INTERFACE LinearSpace3 {
            ...
            inline __both__ LinearSpace3 &operator=(const LinearSpace3 &other) {
                vx = other.vx;
                vy = other.vy;
                vz = other.vz;
                return *this;
            ...
            template<typename L1>
            inline __both__ LinearSpace3(const LinearSpace3<L1> &s) : vx(s.vx), vy(s.vy), vz(s.vz) {}
            ...
            inline __both__ LinearSpace3(const QuaternionT<scalar_t> &q)
                    : vx((q.r * q.r + q.i * q.i - q.j * q.j - q.k * q.k), 2.0f * (q.i * q.j + q.r * q.k),
                         2.0f * (q.i * q.k - q.r * q.j)),
                      vy(2.0f * (q.i * q.j - q.r * q.k), (q.r * q.r - q.i * q.i + q.j * q.j - q.k * q.k),
                         2.0f * (q.j * q.k + q.r * q.i)),
                      vz(2.0f * (q.i * q.k + q.r * q.j), 2.0f * (q.j * q.k - q.r * q.i),
            ...
            /*! compute adjoint matrix */
            inline __both__ const LinearSpace3 adjoint() const {
                return LinearSpace3(cross(vy, vz), cross(vz, vx), cross(vx, vy)).transposed();
            }
            ...
            /*! compute transposed matrix */
            inline __both__ const LinearSpace3 transposed() const {
                return LinearSpace3(vx.x, vx.y, vx.z, vy.x, vy.y, vy.z, vz.x, vz.y, vz.z);
            }
...
// #endif
            ...
            static inline __both__ LinearSpace3 rotate(const vector_t &_u, const scalar_t &r) {
                ...
                scalar_t s = sin(r), c = cos(r);
                return LinearSpace3(u.x * u.x + (1 - u.x * u.x) * c, u.x * u.y * (1 - c) - u.z * s,
                                    u.x * u.z * (1 - c) + u.y * s,
                                    u.x * u.y * (1 - c) + u.z * s, u.y * u.y + (1 - u.y * u.y) * c,
                                    u.y * u.z * (1 - c) - u.x * s,
        ...
        template<typename T>
        inline __both__ LinearSpace3<T> operator-(const LinearSpace3<T> &a) {
        ...
        template<typename T>
        inline __both__ LinearSpace3<T> rcp(const LinearSpace3<T> &a) { return a.inverse(); }
...
// #endif
        ...
        template<typename T>
        inline __both__ LinearSpace3<T> frame(const T &N, const T &dxi) {
        ...
        template<typename T>
        inline __both__ LinearSpace3<T> clamp(const LinearSpace3<T> &space) {
        ...
        template<typename T>
        inline __both__ LinearSpace3<T> operator+(const LinearSpace3<T> &a, const LinearSpace3<T> &b) {
        ...
        template<typename T>
        inline __both__ LinearSpace3<T> operator*(const typename T::scalar_t &a, const LinearSpace3<T> &b) {
            return LinearSpace3<T>(a * b.vx, a * b.vy, a * b.vz);
        }

        template<typename T>
        inline __both__ T operator*(const LinearSpace3<T> &a, const T &b) {
        ...
        template<typename T>
        __both__ inline LinearSpace3<T> operator/(const LinearSpace3<T> &a, const typename T::scalar_t &b) {
            return LinearSpace3<T>(a.vx / b, a.vy / b, a.vz / b);
        }

        template<typename T>
        __both__ inline LinearSpace3<T> operator/(const LinearSpace3<T> &a, const LinearSpace3<T> &b) {
            return a * rcp(b);
        }

        template<typename T>
        inline LinearSpace3<T> &operator*=(LinearSpace3<T> &a, const LinearSpace3<T> &b) { return a = a * b; }

        template<typename T>
        inline LinearSpace3<T> &operator/=(LinearSpace3<T> &a, const LinearSpace3<T> &b) { return a = a / b; }

        template<typename T>
        inline __both__ T xfmPoint(const LinearSpace3<T> &s, const T &a) {
            return madd(T(a.x), s.vx, madd(T(a.y), s.vy, T(a.z * s.vz)));
        }

        template<typename T>
        inline __both__ T xfmVector(const LinearSpace3<T> &s, const T &a) {
            return madd(T(a.x), s.vx, madd(T(a.y), s.vy, T(a.z * s.vz)));
        }

        template<typename T>
        inline __both__ T xfmNormal(const LinearSpace3<T> &s, const T &a) {
        ...
        template<typename T>
        inline bool operator==(const LinearSpace3<T> &a, const LinearSpace3<T> &b) {
        ...
        template<typename T>
        inline std::ostream &operator<<(std::ostream &cout, const LinearSpace3<T> &m) {
