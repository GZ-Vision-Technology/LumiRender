...
namespace owl {
    namespace common {
        ...
        template<typename T>
        __both__ QuaternionT<T> operator+(const QuaternionT<T> &a) { return QuaternionT<T>(+a.r, +a.i, +a.j, +a.k); }

        template<typename T>
        __both__ QuaternionT<T> operator-(const QuaternionT<T> &a) { return QuaternionT<T>(-a.r, -a.i, -a.j, -a.k); }

        template<typename T>
        __both__ QuaternionT<T> conj(const QuaternionT<T> &a) { return QuaternionT<T>(a.r, -a.i, -a.j, -a.k); }

        template<typename T>
        __both__ T abs(const QuaternionT<T> &a) { return sqrt(a.r * a.r + a.i * a.i + a.j * a.j + a.k * a.k); }
        ...
        template<typename T>
        __both__ typename QuaternionT<T>::Vector
        operator*(const QuaternionT<T> &a, const typename QuaternionT<T>::Vector &b) {
        ...
        template<typename T>
        __both__ QuaternionT<T> operator/(const T &a, const QuaternionT<T> &b) { return a * rcp(b); }

        template<typename T>
        __both__ QuaternionT<T> operator/(const QuaternionT<T> &a, const T &b) { return a * rcp(b); }

        template<typename T>
        __both__ QuaternionT<T> operator/(const QuaternionT<T> &a, const QuaternionT<T> &b) { return a * rcp(b); }

        template<typename T>
        __both__ QuaternionT<T> &operator+=(QuaternionT<T> &a, const T &b) { return a = a + b; }

        template<typename T>
        __both__ QuaternionT<T> &operator+=(QuaternionT<T> &a, const QuaternionT<T> &b) { return a = a + b; }
        ...
        template<typename T>
        __both__ QuaternionT<T> &operator/=(QuaternionT<T> &a, const T &b) { return a = a * rcp(b); }

        template<typename T>
        __both__ QuaternionT<T> &operator/=(QuaternionT<T> &a, const QuaternionT<T> &b) { return a = a * rcp(b); }

        template<typename T>
        __both__ typename QuaternionT<T>::Vector
        xfmPoint(const QuaternionT<T> &a,
                 const typename QuaternionT<T>::Vector &b) { return (a * QuaternionT<T>(b) * conj(a)).v(); }
