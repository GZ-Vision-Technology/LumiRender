...
namespace lstd {
    ...
    public:
        ...
        bool is_equal(const pmr &other) const noexcept {
    ...
    private:
        ...
        virtual bool do_is_equal(const pmr &other) const noexcept = 0;
    };

    inline bool operator==(const pmr &a, const pmr &b) noexcept {
        return a.is_equal(b);
    }
    ...
    pmr *new_delete_resource() noexcept;

    // TODO: memory_resource* null_memory_resource() noexcept;
    pmr *set_default_resource(pmr *r) noexcept;

    pmr *get_default_resource() noexcept;

    class monotonic_buffer_resource : public pmr {
    public:
        explicit monotonic_buffer_resource(pmr *upstream)
                : _upstream_resource(upstream) {}

        monotonic_buffer_resource(size_t block_size, pmr *upstream)
        ...
        pmr *upstream_resource() const { return _upstream_resource; }
    ...
    protected:
        ...
        bool do_is_equal(const pmr &other) const noexcept override {
            return this == &other;
        }
    ...
    public:
        ...
        polymorphic_allocator(pmr *r) : _memory_resource(r) {}
        ...
        pmr *resource() const { return _memory_resource; }
